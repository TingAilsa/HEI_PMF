...
require(viridis) # R color palette
require(RColorBrewer) # R color palette
require(ggsci) # R colors for  SCIs including npg, aaas, lancet, jco, tron
library(wesanderson) # gradient &c discrete color palette
...
imp_meta_sites = read.csv("/Users/ztttttt/Documents/HEI PMF/IMPROVE & CNS original/IMPROVE sites.txt",
                          sep = ",", dec = ".")
...
imp_meta_flags = read.csv("/Users/ztttttt/Documents/HEI PMF/IMPROVE & CNS original/IMPROVE flags.txt",
                          sep = ",", dec = ".")
imp_meta_para = read.csv("/Users/ztttttt/Documents/HEI PMF/IMPROVE & CNS original/IMPROVE parameters.txt",
                         sep = ",", dec = ".")
...
imp_data = read.csv("/Users/ztttttt/Documents/HEI PMF/IMPROVE & CNS original/ailsa2be_20221008_205315_uNQ0v IMPROVE.txt",
                    sep = ",", dec = ".")
head(imp_data)
...
ggplot(imp_same_location, aes(x = ParamCode, y = Val, fill = SiteCode)) +
  geom_boxplot() + ylim(0, 20) + ggtitle("unit - µg/m^3 or ng/m^3 for flags")
